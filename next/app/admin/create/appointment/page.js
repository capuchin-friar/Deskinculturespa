      ...
      <header className="appointment-header">
        ...
        <div className="header-title">
          ...
          <div>
            ...
            <p>
              Set up a new consultation appointment for
              your clients.
            </p>
          </div>
        ...
        <aside className="right-column">
          ...
          <section className="preview-card">
            ...
            <div className="section-heading">
              ...
              <p>
                This is how your appointment will appear
                to clients.
              </p>
            ...
            <div className="appointment-preview">
              ...
              <div className="preview-content">
                ...
                <p>
                  {form.description ||
                    "A personalized consultation to assess your skin concerns, recommend the right products and treatments, and answer your questions."}
                </p>
